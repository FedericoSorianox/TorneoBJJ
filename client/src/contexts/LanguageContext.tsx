...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'athletes.form.birthDate': 'Birth Date',
        'athletes.form.wins': 'Career Wins',
        'athletes.form.submissions': 'Submissions',
    ...
    es: {
        ...
        'athletes.form.birthDate': 'Fecha de Nacimiento',
        'athletes.form.wins': 'Victorias',
        'athletes.form.submissions': 'Finalizaciones',
